...
const MOCK_DOCTORS: Doctor[] = [
  { id: "1", name: "Dr.Prakash", specialty: "Cardiologist", status: "available", avatar: "src/assets/profile.jpg" },
  { id: "2", name: "Dr.Prakash", specialty: "Cardiologist", status: "available", avatar: "src/assets/profile.jpg" },
  { id: "3", name: "Dr.Prakash", specialty: "Cardiologist", status: "busy",      avatar: "src/assets/profile.jpg" },
  { id: "4", name: "Dr.Prakash", specialty: "Cardiologist", status: "busy",      avatar: "src/assets/profile.jpg" },
  { id: "5", name: "Dr.Prakash", specialty: "Cardiologist", status: "offline",   avatar: "src/assets/profile.jpg" },
  { id: "6", name: "Dr.Prakash", specialty: "Cardiologist", status: "offline",   avatar: "src/assets/profile.jpg" },
];
